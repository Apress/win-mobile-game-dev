...
namespace HiddenSurfaceRemoval
{
    public partial class Form1 : Form
    {
        ...
        private void mnuMain_Menu_CullFaces_Click(object sender, EventArgs e)
        {
            if (mnuMain_Menu_CullFaces.Checked)
            {
                mnuMain_Menu_CullFaces.Checked = false;
                // Disable hidden surface removal
                gl.Disable(gl.GL_CULL_FACE);
            }
            else
            {
                mnuMain_Menu_CullFaces.Checked = true;
