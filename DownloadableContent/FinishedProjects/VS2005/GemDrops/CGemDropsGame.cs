...
namespace GemDrops
{
    class CGemDropsGame : GameEngine.CGameEngineGDIBase
    {
        /// <summary>
            ...
            : base(gameForm)
        {
            ...
            HighScores.InitializeTable("Normal", 15, "Game mode: Normal");
            HighScores.BackColor = Color.DarkSlateBlue;
            HighScores.TextColor = Color.White;
            HighScores.TableBackColor = Color.MidnightBlue;
            HighScores.TableTextColor1 = Color.White;
            HighScores.TableTextColor2 = Color.SlateBlue;
            HighScores.NewEntryBackColor = Color.White;
            HighScores.NewEntryTextColor = Color.SlateBlue;
            HighScores.ShowTableBorder = true;
            // Load high scores
            HighScores.EncryptionKey = "gemdrops";
            HighScores.LoadScores();

            // Initialize the messageboxes
            MessageBox.BackColor = Color.DarkSlateBlue;
            MessageBox.TitleBackColor = Color.MidnightBlue;
            MessageBox.TitleTextColor = Color.White;
            MessageBox.MessageTextColor = Color.White;
