...
{
    public abstract class CGameObjectBase : IComparable<CGameObjectBase>
    {
        ...
        /// </summary>
        protected internal virtual void UpdatePreviousPosition()
        {
        ...
        /// <summary>
        /// Allow the game object list to be sorted.
        /// </summary>
        public virtual int CompareTo(CGameObjectBase other)
        {
            // We don't know how the game will want to sort its objects,
            // so just return 0 to indicate that the two objects are
            // equal. Individual objects can override this to provide
            // their own sorting mechanism.
            return 0;
        }
