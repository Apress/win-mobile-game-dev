...
{
    public partial class Method2_DoubleBuffering : Form
    {
        ...
        public Method2_DoubleBuffering()
        {
            InitializeComponent();
        }
        ...
        private void Method2_DoubleBuffering_Load(object sender, EventArgs e)
        {
        ...
        private void Method2_DoubleBuffering_Closing(object sender, CancelEventArgs e)
        {
