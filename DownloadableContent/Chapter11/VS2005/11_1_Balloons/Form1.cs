    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _game = new CBalloonsGame(this);

                // Check capabilities...
                GameEngineCh11.CGameEngineBase.Capabilities missingCaps;
                // Check game capabilities -- OR each required capability together
                missingCaps = _game.CheckCapabilities(GameEngineCh11.CGameEngineBase.Capabilities.OpenGL);
