...
namespace GameEngineCh6
{
    public abstract class CGameObjectGDIBase : CGameObjectBase
    {
        ...
        public Rectangle _previousRenderRect;
        ...
        public virtual Rectangle GetRenderRectangle(float interpFactor)
        {
            ...
            return new Rectangle((int)GetDisplayXPos(interpFactor), (int)GetDisplayYPos(interpFactor), Width, Height);
        }
        ...
        public void MoveToFront()
        {
            ...
            // Mark is as moved so that it is redrawn
            this.HasMoved = true;
        }
